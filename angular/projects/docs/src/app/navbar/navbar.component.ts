    ...
    <nav class="flex justify-between align-middle px-10 py-2 shadow-sm h-[65px] mb-[15px]">
      ...
      <div class="flex">
        <ul class="flex items-center text-[14px]">
          <li class="active:text-blue-700 active:underline">
            <a routerLink="/" ariaCurrentWhenActive="page" class="px-3 mx-1">SDK</a>
          </li>
          <li class="active:text-blue-700 active:underline">
            <a routerLink="/components" ariaCurrentWhenActive="page" class="px-3 mx-1">Components</a>
          </li>
        </ul>
      </div>
    </nav>
