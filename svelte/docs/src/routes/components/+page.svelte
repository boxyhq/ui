...
<main>
  ...
  <div class="hero-body">
    ...
    <div class="login-with-failing-onsubmit">
      <Login inputLabel={'Team domain*'} placeholder={'contos@boxyhq.com'} onSubmit={onSubmitButtonFail} />
      ...
      <button class="btn-toggle" on:click={() => (withFailingOnsubmitIsActive = !withFailingOnsubmitIsActive)}
        >Hide code</button>
