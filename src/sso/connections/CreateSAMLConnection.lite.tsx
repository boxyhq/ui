  ...
  return (
    <>
      ...
      <div className='min-w-[28rem] rounded border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800'>
        ...
        <input name='rawMetadata' required={false} type='textarea' placeholder='Paste the raw XML here' />
      </div>
      <div className='min-w-[28rem] rounded border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800'>
        <label for='metadataUrl'>Metadata URL</label>
        <input name='metadataUrl' required={false} type='url' placeholder='Paste the Metadata URL here' />
      </div>
    </>
  );
}
